...
export default function ReceptionDashboard({ profile, panel, loading, error, updatedAt, onRefresh, onNavigate, onNewStudent, onScheduleStudent, onRegisterPayment, teachers = [], onChangeTeacher, notificationOpen = false, onNotificationOpenChange, hideHeaderBell = false }) {
  const [period, setPeriod] = useState('upcoming')
  const [expandedTimes, setExpandedTimes] = useState({})
  const notificationsOpen = notificationOpen
  const setNotificationsOpen = (value) => onNotificationOpenChange?.(typeof value === 'function' ? value(notificationOpen) : value)
